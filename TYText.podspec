...
# 主页
s.homepage = "https://github.com/12207480/TYText"
...
s.source = { :git => "https://github.com/12207480/TYText.git", :tag => s.version.to_s }
# 如果使用pod 需要导入哪些资源
s.source_files = "TYTextKitDemo/TYText/**/*.{h,m}"
# s.resources = "**/*/*.bundle"
# 框架是否使用的ARC
s.requires_arc = true
end
